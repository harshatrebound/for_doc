...
const VirtualTeamBuildingPage: React.FC = () => {
      ...
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 lg:px-8">
          ...
          >
            ...
            >
              Interactive Virtual Games for Remote Teams
            </motion.h2>
            <motion.h1
              ref={ref}
              initial={{ opacity: 0, y: 20 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/80 to-transparent">
                ...
                <p className="text-white text-lg transform translate-y-4 opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100">Team Builder</p>
              </div>
            </motion.div>
          </div>
        </div>
...
export default VirtualTeamBuildingPage; 