    ...
    <Link href={`/${post.slug}`} className="block h-full">
      <div className="group bg-white rounded-xl overflow-hidden shadow hover:shadow-lg transition-all duration-300 hover:-translate-y-1 flex flex-col h-full">
        ...
        <div className="p-5 flex flex-col flex-grow">
          ...
          <div className="inline-flex items-center text-sm font-semibold text-[#8B5C9E] group-hover:text-[#6b4578] transition-colors mt-auto">
...
export const FeaturedPost = ({ post }: { post: BlogPost }) => {
  return (
    <Link href={`/${post.slug}`} className="block">
      <div className="group relative overflow-hidden bg-white rounded-xl shadow-md transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="p-6 lg:w-1/2 lg:p-8 flex flex-col">
            ...
            <div className="inline-flex items-center font-semibold text-[#8B5C9E] group-hover:text-[#6b4578] transition-colors">
